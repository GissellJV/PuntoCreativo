    ...
    <section class="section">
        <div class="container">
            ...
            <div class="section-title">
                <span class="eyebrow">Administración de servicios</span>

                <h2>
                    Registrar <span class="gradient-text">nuevo servicio</span>
                </h2>

                <p>
                    Complete los datos para agregar un nuevo servicio al catálogo de Punto Creativo.
                </p>
            </div>
            ...
            <div class="quote-shell">
                ...
                <div class="quote-info">
                    ...
                    <p>
                        Ingrese los datos principales del servicio que desea registrar.
                    </p>
                    ...
                    <div class="contact-list">
                        ...
                        <div class="contact-item">
                            ...
                            <span>Nombre y descripción del servicio.</span>
                        </div>
                ...
                <form action="{{ route('servicios.store') }}"
                      ...
                      style="padding: 46px !important; display: grid !important;
        ...
        align-content: start !important;" >
                    ...
                    <p class="form-note">
                        Complete todos los campos necesarios antes de guardar.
                    </p>
