...
<head>
    ...
    <meta name="description" content="Política de cookies de Punto Creativo.">
    <title>Política de cookies | Punto Creativo</title>
    <link
        rel="stylesheet"
    ...
    <section class="store-section">
        <div class="container">
            ...
            <article class="legal-card">
                ...
                <h2>Política de cookies y almacenamiento local</h2>

                <div class="legal-meta">
                    Última actualización: julio de 2026 · Este prototipo no utiliza cookies publicitarias.
                </div>

                <p>
                    El sitio utiliza almacenamiento local del navegador para que determinadas funciones continúen disponibles entre páginas.
                </p>

                <h2>Información guardada</h2>

                <ul>
                    <li>Servicios añadidos al carrito y cantidades seleccionadas.</li>
                    <li>Cupón de demostración aplicado.</li>
                    <li>Pedidos generados durante las pruebas.</li>
                    <li>Preferencia sobre el aviso de cookies.</li>
                </ul>

                <h2>Control del usuario</h2>

                <p>
                    El usuario puede borrar esta información desde la configuración de privacidad del navegador. Al hacerlo, se eliminarán el carrito y el historial local.
                </p>

                <h2>Servicios futuros</h2>
