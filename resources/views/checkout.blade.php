...
<head>
    ...
    <meta name="description" content="Checkout de demostración para contratar servicios de Punto Creativo.">
...
<main>
    ...
    <header class="page-hero">
        <div class="container">
            ...
            <span class="eyebrow">Checkout seguro de demostración</span>

            <h1>Completa tu solicitud.</h1>

            <p>
                Compra como invitado. El flujo no requiere crear una cuenta y no procesa dinero real.
            </p>
        ...
        <div class="container checkout-layout">
            ...
            <div class="checkout-card">
                ...
                <div class="progress-steps">
                    <div class="progress-step active" data-progress="1">1. Datos</div>
                    <div class="progress-step" data-progress="2">2. Pago</div>
                    <div class="progress-step" data-progress="3">3. Revisión</div>
                </div>
                ...
                <form id="checkoutForm" novalidate>
                    ...
                    <section class="checkout-step active" data-step="1">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="field">
                                <label for="businessName">Empresa o proyecto</label>
                                <input id="businessName">
                            </div>

                            <div class="field full">
                                <label for="deliveryNotes">Indicaciones para la entrega digital</label>
                                <textarea id="deliveryNotes" placeholder="Correo alternativo, formato requerido, redes donde se publicará o referencias del proyecto"></textarea>
                            </div>
                        ...
                        <div class="checkout-nav">
                            ...
                            <button class="btn btn-primary" type="button" data-next="2">Continuar al pago</button>
                        </div>
                    ...
                    <section class="checkout-step" data-step="2">
                        ...
                        <div class="demo-alert">
                            <strong>Modo de prueba:</strong> no introduzcas datos bancarios reales.
                        </div>

                        <div class="payment-options">

                            <label class="payment-option">
                                <input type="radio" name="payment" value="PayPal Sandbox" checked>
                                <span><strong>PayPal Sandbox</strong><p>Simulación de aprobación.</p></span>
                            </label>

                            <label class="payment-option">
                                <input type="radio" name="payment" value="Stripe Test Mode">
                                <span><strong>Tarjeta de prueba</strong><p>Usa datos de prueba.</p></span>
                            </label>

                            <label class="payment-option">
                                <input type="radio" name="payment" value="Tigo Money">
                                <span><strong>Tigo Money</strong><p>Pago manual.</p></span>
                            </label>

                        </div>

                        <div class="payment-fields" id="stripeFields">
                        ...
                        <div class="checkout-nav">
                            <button class="btn btn-secondary" type="button" data-back="1">Regresar</button>
                            <button class="btn btn-primary" type="button" data-next="3">Revisar pedido</button>
                        </div>
                    ...
                    <section class="checkout-step" data-step="3">
                        ...
                        <div class="checkout-nav">
                            <button class="btn btn-secondary" type="button" data-back="2">Regresar</button>
            ...
            <aside class="order-summary" id="checkoutSummary"></aside>
