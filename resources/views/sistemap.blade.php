...
<head>
    ...
    <meta name="description" content="Mapa de navegación de Punto Creativo.">

    <title>Mapa del sitio | Punto Creativo</title>
...
Arquitectura de información
            ...
            <h1>
                Mapa del sitio de Punto Creativo.
            </h1>



            <p>
                Las pantallas principales están conectadas para que cualquier servicio pueda encontrarse y contratarse en tres clics o menos.
            </p>
    ...
    <section class="store-section">
        ...
        <div class="container">
            ...
            <div class="sitemap-card sitemap-tree">
                ...
                <div class="map-node">
                    ...
                    <div class="map-links">
                        ...
                        <a href="{{route('producto')}}?id=anuncio-publicitario">
                            Detalle de producto
                        </a>
